...
from app.api.v1.endpoints import auth, users, knowledgebases, documents, assistants, chats, chunks
...
api_router.include_router(chunks.router, prefix="", tags=["Chunks"])
